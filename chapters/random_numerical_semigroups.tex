...
In chapter \ref{chap:results}, we prove part (b) using standard methods in the probabilistic method (Theorem \ref{thm:lowerbound}). We also prove a result related to part (c) (Therem \ref{thm:upperbound}).
